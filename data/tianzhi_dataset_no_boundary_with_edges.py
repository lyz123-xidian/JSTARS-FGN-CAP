...
class HyperDataset(udata.Dataset):
    def __init__(self, mode='train', aug=True):
        ...
        items = []
        if self.mode == 'train':
            img_path = '/home/data1/jojolee/Tianzhibei2020/Tianzhibei2019OriginalDataset/cropped/512/train/img'
            mask_path = '/home/data1/jojolee/Tianzhibei2020/Tianzhibei2019OriginalDataset/cropped/512/train/label'
            ...
            # add augment
            img_path = '/home/data1/jojolee/Tianzhibei2020/Tianzhibei2019OriginalDataset/cropped/512/train_add/img'
            mask_path = '/home/data1/jojolee/Tianzhibei2020/Tianzhibei2019OriginalDataset/cropped/512/train_add/label'
            img_name = glob.glob(os.path.join(img_path, '*.tif'))
            mask_name = glob.glob(os.path.join(mask_path, '*.png'))
            img_name.sort()
            mask_name.sort()
            ...
            img_path = '/home/data1/jojolee/Tianzhibei2020/Tianzhibei2019OriginalDataset/cropped/512/valid/img'
            mask_path = '/home/data1/jojolee/Tianzhibei2020/Tianzhibei2019OriginalDataset/cropped/512/valid/label'
            img_name = glob.glob(os.path.join(img_path, '*.tif'))
            mask_name = glob.glob(os.path.join(mask_path, '*.png'))
            img_name.sort()
            mask_name.sort()
