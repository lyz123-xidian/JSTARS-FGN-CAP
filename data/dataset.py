...
class HyperDataset(udata.Dataset):
    def __init__(self, mode='train', aug=True):
        ...
        items = []
        if self.mode == 'train':
            img_path = '/home/data1/jojolee/seg_exp/data/ori/Vaihingen/train_val/512/img/train'
            mask_path = '/home/data1/jojolee/seg_exp/data/ori/Vaihingen/train_val/512/label/train'
            ...
            # add augment
            img_path = '/home/data1/jojolee/seg_exp/data/ori/Vaihingen/train_val/512/img/train_add'
            mask_path = '/home/data1/jojolee/seg_exp/data/ori/Vaihingen/train_val/512/label/train_add'
            img_name = glob.glob(os.path.join(img_path, '*.tif'))
            mask_name = glob.glob(os.path.join(mask_path, '*.tif'))
            img_name.sort()
            mask_name.sort()
            ...
            mask_path = '/home/data1/jojolee/seg_exp/data/ori/Vaihingen/train_val/512/label/val'
            img_name = glob.glob(os.path.join(img_path, '*.tif'))
            mask_name = glob.glob(os.path.join(mask_path, '*.tif'))
            img_name.sort()
            mask_name.sort()
