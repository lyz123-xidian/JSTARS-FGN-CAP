...
# from models.compared.ocnet import DeepLabv3_plus
...
args = {
    'ckpt_path': './ckpt_addition/v/cityscapes/resnet101+EGFTM+cap',
    'num_classes': 19,
    'start_epoch': 1, 'iteration': 0,
    'epoch_num': 100, 'batch_size': 4,
...
def main(args):
    ...
    # Resume
    # resume_file = ''
    resume_file = checkpoint_path + '/net_11epoch.pth'
    if resume_file:
